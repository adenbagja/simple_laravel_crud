...
class BiodataController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $biodata->save();
        return redirect()->route('biodata.index')->with('success', 'Biodata siswa updated successfully');
    }
    ...
    public function destroy($id)
    {
        $biodata = Biodata::find($id);
        $biodata->delete();
        return redirect()->route('biodata.index')->with('success', "Biodata siswa Deleted Successfully");
    }
}
